...
const treeSimulationPrompt = ai.definePrompt({
  ...
  The visualizationData JSON string must be an array of step objects. Each step object must contain the state of the tree. The state should include:
  - "nodes": The array of all nodes, including their id, value, x, y coordinates, and state properties (like 'color').
  - "edges": The array of all edges, each with "source" and "target" ids.
  ...
  - "found_at": The 'id' of the target node if found in this step (for search algorithms), otherwise null.
  ...
  **Example for In-order Traversal on a small tree:**
  {
    "simulationDescription": "In-order traversal visits the left subtree, then the root, then the right subtree. We start at the root node 10...",
    "visualizationData": "[
      {
        \\"nodes\\": [
          {\\"id\\":\\"10\\",\\"value\\":10,\\"x\\":250,\\"y\\":50,\\"color\\":\\"active\\"},
          {\\"id\\":\\"5\\",\\"value\\":5,\\"x\\":150,\\"y\\":150,\\"color\\":\\"default\\"},
          {\\"id\\":\\"15\\",\\"value\\":15,\\"x\\":350,\\"y\\":150,\\"color\\":\\"default\\"}
        ],
        \\"edges\\": [
          {\\"source\\":\\"10\\",\\"target\\":\\"5\\"},
          {\\"source\\":\\"10\\",\\"target\\":\\"15\\"}
        ...
        \\"traversalOrder\\": [],
        \\"stepDescription\\": \\"Start at root (10). Move to left child (5).\\",
        \\"found_at\\": null
      },
      {
        \\"nodes\\": [
          {\\"id\\":\\"10\\",\\"value\\":10,\\"x\\":250,\\"y\\":50,\\"color\\":\\"default\\"},
          {\\"id\\":\\"5\\",\\"value\\":5,\\"x\\":150,\\"y\\":150,\\"color\\":\\"active\\"},
          {\\"id\\":\\"15\\",\\"value\\":15,\\"x\\":350,\\"y\\":150,\\"color\\":\\"default\\"}
        ],
        \\"edges\\": [],
        \\"traversalOrder\\": [],
        \\"stepDescription\\": \\"At node (5). It has no left child. Visit node (5).\\",
        \\"found_at\\": null
      },
      {
        \\"nodes\\": [
          {\\"id\\":\\"10\\",\\"value\\":10,\\"x\\":250,\\"y\\":50,\\"color\\":\\"default\\"},
          {\\"id\\":\\"5\\",\\"value\\":5,\\"x\\":150,\\"y\\":150,\\"color\\":\\"visited\\"},
          {\\"id\\":\\"15\\",\\"value\\":15,\\"x\\":350,\\"y\\":150,\\"color\\":\\"default\\"}
        ],
        \\"edges\\": [],
        \\"traversalOrder\\": [5],
        \\"stepDescription\\": \\"Node (5) visited. Return to parent (10) and visit it.\\",
        \\"found_at\\": null
      }
    ]"
  }
